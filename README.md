...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dark-violet-3cbc
```

A live public deployment of this template is available at [https://dark-violet-3cbc.templates.workers.dev](https://dark-violet-3cbc.templates.workers.dev)
